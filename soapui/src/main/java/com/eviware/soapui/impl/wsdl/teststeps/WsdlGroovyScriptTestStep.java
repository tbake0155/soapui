...
public class WsdlGroovyScriptTestStep extends WsdlTestStepWithProperties implements PropertyExpansionContainer {
    private final static Logger logger = org.apache.logging.log4j.LogManager.getLogger("groovy.log");
    ...
    public TestStepResult run(TestCaseRunner testRunner, TestCaseRunContext context) {
        ...
        if (log == null) {
            ...
            ((org.apache.logging.log4j.core.Logger)log)
                    .addAppender(new DefaultConfiguration().getAppender("GLOBAL_GROOVY_LOG"));
        }
